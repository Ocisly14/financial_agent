...
Use the following order. State the gap when a section lacks reliable evidence; do not fill it with general knowledge.

## 1. Conclusion and data timestamp

- Give the constructive / neutral / cautious relative view, applicable scope, and confidence in one paragraph.
- State `as_of`, the SPY benchmark, comparison scope, and unavailable sectors.
- Lead a whole-market report with the cross-sector conclusion. In a single-sector report, identify the ETF as a proxy and state that no cross-sectional ranking was performed.
...
## 5. Disagreements, risks, and data gaps

- List conflicts between absolute and relative trends.
- State the observable condition most likely to overturn the main view.
- List failed data calls, unavailable sectors, unconfirmed news, and metrics outside tool coverage.

## 6. Sources

List the links actually used in the news research. Do not invent a web source for data returned by the sector tool.
