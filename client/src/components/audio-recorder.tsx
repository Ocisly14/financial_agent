...
export const AudioRecorder = ({
    ...
    const mutation = useMutation({
        ...
        onError: (e) => {
            toast({
                variant: "destructive",
                title: t("audio.unableToStartRecording"),
            ...
            <div className="flex items-center">
                ...
                {isRecording ? (
                    <Tooltip>
                        ...
                        <TooltipContent className="m-2">
                            <span>{t("audio.resetRecording")}</span>
                        </TooltipContent>
                    </Tooltip>
                ) : null}
                ...
                <Tooltip>
                    <TooltipTrigger asChild>
                        {!isRecording ? (
                            ...
                            >
                                ...
                                <span className="sr-only">{t("audio.useMicrophone")}</span>
                            </Button>
                        ) : (
                            <Button
                    ...
                    <TooltipContent side="right">
                        <span>{!isRecording ? t("audio.useMicrophone") : t("common.send")} </span>
                    </TooltipContent>
                </Tooltip>
            </div>
        </div>
